...
typeCheckProgram(program(Classes, Vars, Inst),
                 program(TClasses, TVars, TInst):id('Void')) :-
  typeCheckClasses(Classes, [], [], InheritanceC, TypingC, TClasses),
  typeCheckVars(Vars, none, InheritanceC, TypingC, TypingC1, TVars),
  typeCheckInst(Inst, none, InheritanceC, TypingC1, none, TInst).


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% typeCheckClasses/6
%
% typeCheckClasses(+Classes, +InheritanceC, +TypingC,
%                                   -NewInheritanceC, -NewTypingC, -TClasses)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%                                      -NewInheritanceC, -NewTypingC, -TClass)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% typeCheckCexp/3
%
% typeCheckCexp(+Cexp, +InheritanceC, -TCExp)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% typeCheckVars/6
%
% typeCheckVars(+Vars, +CurrentClass, +InheritanceC,
%                                              +TypingC, -NewTypingC, -TVars)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% typeCheckVar/6
%
% typeCheckVar(+Var, +CurrentClass, +InheritanceC,
%                                                +TypingC, -NewTypingC, -TVar)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% typeCheckMethods/6
%
% typeCheckMethods(+Methods, +CurrentClass, +InheritanceC, +TypingC,
%                                                      -NewTypingC, -TMethods)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% typeCheckMethod/6
%
% typeCheckMethod(+Method, +CurrentClass, +InheritanceC, +OldTypingC,
%                                                       -NewTypingC, -TMethod)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

typeCheckMethod(method(Id, Formals, Cexp, Locals, Inst), CClass, 
              InheritanceC, TypingC, [(CClass@Id):(TFs->RT)|TypingC],
              method(Id, TFormals, TCexp, TLocals, TInst:T):(TFs->RT)) :-
...
% typeCheckInst/7
%
% typeCheckInst(+Inst, +CurrentClass, +InheritanceC, +TypingC,
%                                                         +ReturnType, -TInst)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% typeCheckExp/5
% typeCheckExp(+Exp, +CurrentClass, +InheritanceC, +TypingC, -TExp)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% typeCheckAll/5
%
% typeCheckAll(+Exps, +CurrentClass, +InheritanceC, +TypingC, -TExps)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% findType/4
%
% findType(+Id, +InheritanceC, +TypingC, -Type)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% findMethod/5
%
% findMethod(+Class, +Id, +InheritanceC, +TypingC, Type) 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% contravariant/3
%
% contravariant(+TypeInheritedMethod, + TypeNewMethod, +InheritanceC)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
